...
<nav>
    <div class="container">
        <ul>
            ...
            <li>
                <div class="menu-list-genre" data-mode="genre" data-genre="G016">Manga</div>
            </li>
            <li>
                <div class="menu-list-genre" data-mode="genre" data-genre="G018">Manhwa</div>
            </li>
        </ul>
    </div>
</nav>
<link rel="stylesheet" href="view/layout/css/filter.css">
