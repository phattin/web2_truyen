<?php
    ...
    if (isset($_POST['act']) && $_POST['act'] === 'filter') {
        ...
        $isNew = isset($_POST['is_new']) && $_POST['is_new'] === 'true';
        $isHot = isset($_POST['is_hot']) && $_POST['is_hot'] === 'true';
        ...
        $totalProducts = $productDB->getTotalFilteredProducts($minPrice, $maxPrice, $genres, $isNew, $isHot);
        $totalPages = ceil($totalProducts / $limit);

        // Lấy danh sách sản phẩm đã lọc và phân trang
        $products = $productDB->getFilteredProducts($limit, $offset, $minPrice, $maxPrice, $genres, $isNew, $isHot);
